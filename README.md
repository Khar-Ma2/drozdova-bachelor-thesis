...
- **3 перевикористовуваних UI-компонентів** (`Card`, `Button`, `Dialog`)
...
- `Home` — hero-банер, картка автора, сітка можливостей
- `Theory` — таймлайн із кольоровими нодами, календар із модальними вікнами де можна переглянути деталі
...
**🧩 UI-компоненти** — перевикористовувані «будівельні блоки»:
