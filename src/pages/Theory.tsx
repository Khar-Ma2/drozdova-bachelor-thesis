    ...
    const calendarDays = [
        {
            ...
            details: "Резолюція ООН 62/139 (2007). Цього дня у школах проводять «блакитний день» — учні та вчителі носять щось блакитного кольору. На уроках англійської: тематичні уроки «My Unique Strengths», створення візуальних розкладів та використання PECS-карток. Фокус: побудова передбачуваного, візуально структурованого та сенсорно-дружнього середовища для учнів з РАС."
        },
        {
            date: "3 грудня",
            title: "Міжнародний день людей з обмеженими можливостями",
            color: "var(--colors-nozology-ora)",
            details: "Проголошений Генеральною Асамблеєю ООН у 1992 р. Актуалізація питань доступності: архітектурні рішення (пандуси, тактильні покажчики), універсальний дизайн у дидактичних матеріалах та цифровому контенті. На уроках англійської: дискусії «Accessible World Around Us», адаптовані рухливі ігри TPR для учнів з ОРА, створення мультисенсорних карток з рельєфним шрифтом."
        },
        {
            date: "24 січня",
            title: "Міжнародний день освіти",
            color: "var(--colors-nozology-rdug)",
            details: "Встановлений Генеральною Асамблеєю ООН у 2018 р. (Резолюція 73/25). Наголошення на праві кожної дитини — включаючи учнів з ООП та ТОП — на якісне, безпечне та інклюзивне навчання. На уроках англійської: проєкт «Education for Everyone», перегляд коротких адаптованих відео TED-Ed про різноманітність у навчанні, складання колажів «My Learning Journey»."
        }
    ];
